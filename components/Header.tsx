      ...
      <nav className="flex-grow overflow-y-auto px-3 space-y-2 no-scrollbar">
        ...
        {isSidebarOpen && (
            <div className="mt-8 px-2">
                <div className="bg-white/[0.01] border border-white/5 rounded-2xl p-2">
                    <p className="text-[7px] font-black text-gray-700 uppercase tracking-widest text-center mb-1">Module Partner</p>
                    <AdUnit slot="7406471479" className="my-0 scale-90" />
                </div>
            </div>
        )}
      </nav>
