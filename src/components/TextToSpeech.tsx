...
const TextToSpeech: React.FC<TextToSpeechProps> = ({ t }) => {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center animate-fadeIn">
      ...
      <h2 className="text-4xl font-black text-white uppercase tracking-tighter mb-4">Text to Speech</h2>
      <p className="text-gray-500 text-lg max-w-xl leading-relaxed">
        Neural voice synthesis. Convert your written content into natural-sounding speech with multiple voice profiles.
      </p>
