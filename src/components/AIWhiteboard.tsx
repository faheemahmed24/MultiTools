...
const AIWhiteboard: React.FC<AIWhiteboardProps> = ({ t }) => {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center text-center animate-fadeIn px-6">
      <div className="bg-zinc-50 dark:bg-zinc-900 p-10 rounded-lg border border-[var(--border-app)] mb-10 shadow-elevation-1">
        <SwatchIcon className="w-16 h-16 text-zinc-900 dark:text-zinc-100" />
      </div>
      <h2 className="text-3xl font-bold text-[var(--text-primary)] uppercase tracking-tight mb-4">AI Whiteboard</h2>
      <p className="text-zinc-500 text-base max-w-lg leading-relaxed font-medium">
        Sketch to technical diagram. Transform your visual ideas into structured diagrams and professional assets.
      </p>
